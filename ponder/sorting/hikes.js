...
const searchb = document.getElementById("button");
...
// const hikes = [{name: "Tom", age: 5},{name: "Jake", age: 15},{name: "Andy", age: 9}];

// console.log(hikes);
// console.log(hikes.sort(custsort));
